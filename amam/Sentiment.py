...
import nltk #why won't this impo
#from spacy import English #replaces nltk
import yaml
import sys
import os
import re

#text=str(sys.argv[1]) # input
...
class Splitter(object):
    ...
    def __init__(self):
        ...
        #nlp=English()
        #doc=nlp(self) #what goes in here?
...
def value_of(sentiment): #change this function for new lexicon
